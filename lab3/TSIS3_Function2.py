...
def above_5_5_movies(movie_list):
    return list(filter(above_5_5, movie_list))
...
# Task 4: Function to compute average IMDB score of a list of movies
...
# Task 5: Function to compute average IMDB score by category
